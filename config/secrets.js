...
module.exports = {
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '440320289483896',
    clientSecret: process.env.FACEBOOK_SECRET || '2035ea1e049d62b23b6680aeefde6246',
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '82879612467-4uolo4idj23grt0p2dlsqmblelmog9lt.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'BRYa_g2zpelsVXAC1jqNLkCk',
